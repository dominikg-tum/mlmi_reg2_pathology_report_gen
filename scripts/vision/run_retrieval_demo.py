"""Smoke test: question-conditioned retrieval with (high, medium_parent) pairs."""
...
TIER_TO_LEVEL = {
    Tier.GLOBAL_FEATURES.value: "medium",
    Tier.LOCAL_FEATURES.value: "high",
    Tier.INTEGRATION.value: "high",
    "global_features": "medium",
    "local_features": "high",
    "integration": "high",
}
...
def main() -> None:
    ...
    level = TIER_TO_LEVEL.get(args.node_tier, "high")
    ...
    for i, rp in enumerate(pairs):
        ...
        print(
            ...
            f"coord={rp.coord} parent={parent} idx={rp.index}"
        )
